...
#ifndef CEPH_LIBRBD_CACHE_IMAGE_WRITETHROUGH
#define CEPH_LIBRBD_CACHE_IMAGE_WRITETHROUGH
...
public:
  ...
  virtual ~ImageWriteThroughInterface() {
  }
...
class ImageWriteThrough : public ImageWriteThroughInterface {
public:
  using ImageWriteThroughInterface::Extents;

  explicit ImageWriteThrough(ImageCtxT &image_ctx);
...
extern template class librbd::cache::ImageWriteThrough<librbd::ImageCtx>;

#endif // CEPH_LIBRBD_CACHE_IMAGE_WRITETHROUGH
