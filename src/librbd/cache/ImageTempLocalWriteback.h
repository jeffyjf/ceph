...
#ifndef CEPH_LIBRBD_CACHE_IMAGE_TEMP_LOCAL_WRITEBACK
#define CEPH_LIBRBD_CACHE_IMAGE_TEMP_LOCAL_WRITEBACK
...
public:
  ...
  virtual ~ImageTempLocalWritebackInterface() {
  }
...
class ImageTempLocalWriteback : public ImageTempLocalWritebackInterface {
public:
  using ImageTempLocalWritebackInterface::Extents;

  explicit ImageTempLocalWriteback(ImageCtxT &image_ctx);
...
extern template class librbd::cache::ImageTempLocalWriteback<librbd::ImageCtx>;

#endif // CEPH_LIBRBD_CACHE_IMAGE_TEMP_LOCAL_WRITEBACK
