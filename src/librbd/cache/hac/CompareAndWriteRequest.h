...
#ifndef CEPH_LIBRBD_CACHE_HAC_COMP_WRITE_REQUEST_H
#define CEPH_LIBRBD_CACHE_HAC_COMP_WRITE_REQUEST_H
...
class CompareAndWriteRequest {
public:
  CompareAndWriteRequest(CephContext *cct):m_cct(cct){}
...
#endif // CEPH_LIBRBD_CACHE_HAC_COMP_WRITE_REQUEST_H